...
func (s *IntegrationTestSuite) testTrade() {
	...
	// Create trade
	s.execCreateTrade(s.chainA, 0, admin1.String(), tradetypes.GetSampleTradeData(tradetypes.TradeTypeBuy), `{}`, tradetypes.GetSampleCoinMintingPriceJson(), tradetypes.GetSampleExchangeRateJson(), admin1.String(), ggezHomePath, fees.String())
	...
	s.execCreateTrade(s.chainA, 0, "", tradeData, `{}`, tradetypes.GetSampleCoinMintingPriceJson(), tradetypes.GetSampleExchangeRateJson(), admin1.String(), ggezHomePath, fees.String())
